...
4. A função `start` é onde inicia o processamento. Ela se conecta ao Redis, recupera os dados das unidades de estoque e agrupa a cada empreendimento o valor do m² de unidades disponíveis, processa esses dados e os armazena de volta no Redis.
