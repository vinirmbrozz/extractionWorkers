...
versao = "v1.01 Tiago F. 24/11/2023 trilha criada"
versao = "v1.02 Tiago F. 01/12/2023 ajustando valores globais"
trilha = "vendas_vgvempreendqty"
...
def start(log :LogService):
    ...
    for valor in vgv_p_empreend:
        ...
        if isAssociative == False:
            resultado = df.groupby("enterpriseName")["value"].count().reset_index()
